...
In the previous lesson, we learned how to draw a line on a 2D surface. Now we'll use that function to draw the most basic type of 3D object: a wireframe.
...
// 3D diagram of a camera pointing toward positive Z
...
// 3D diagram of vertices intersecting the plane
...
// Top down diagram of projection
...
// Top down diagram of triangles

We know these triangles are what's called *similar triangles*, meaning they have the same angles—in other words, they're uniformly scaled up or down versions of one another. A property of similar triangles is that the scale is equal for all sides, which in our case means
